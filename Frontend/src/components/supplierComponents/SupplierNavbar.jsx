...
import { Menu, X, Shield, Package, ShoppingCart, Users, DollarSign, ChartBar } from 'lucide-react';
...
const navigate = useNavigate();
  ...
  const navItems = [
    ...
    { to: '/supplier/revenue', label: 'Revenue', icon: DollarSign },
    { to: '/supplier/stats', label: 'Stats', icon: ChartBar },
  ];
